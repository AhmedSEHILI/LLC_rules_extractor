...
from PyQt5.QtWidgets import (
    ...
    QGroupBox, QPushButton, QLabel, QLineEdit, QTextEdit, QToolButton,
...
class RuleExtractionView(QMainWindow):
    # La fenêtre principale avec un QStackedWidget pour basculer entre les différentes pages (ontologies, extraction de règles, etc.).
    ...
    def __init__(self):
        ...
        # Layout principal : colonne de gauche + zone centrale
        ...
        # Barre d'outils (zoom, recherche, etc.)
...
class RuleExtractionController:
    ...
    def do_charger_ontologie(self):
        file_path, _ = QFileDialog.getOpenFileName(
            self.view, "Charger une ontologie", "", "Fichiers OWL (*.owl);;Tous les fichiers (*)"
        )
        if file_path:
    ...
    def do_visualiser_ontologie(self):
        # Afficher le contenu de la dernière ontologie chargée dans le volet central
    ...
    # Fonction pour lancer AMIE3 réellement
    def do_lancer_amie3(self):
        # Détermine le chemin du fichier amie3.jar dans le même répertoire que ce script
        ...
        # Construire la commande pour lancer AMIE3
        # On suppose que le fichier "ontology.nt" se trouve dans le répertoire de travail courant.
        ...
        try:
            ...
            stdout, stderr = process.communicate(timeout=60)  # attendre jusqu'à 60 secondes
            output = stdout
            if stderr:
                output += "\nErreur:\n" + stderr
    ...
    # Fonctions de zoom (exemple simplifié)
    def zoom_in(self):
